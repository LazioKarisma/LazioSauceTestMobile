...
public class Test {
	...
	private static AndroidDriver<AndroidElement> fillAndroidDriver(DesiredCapabilities caps)
			throws MalformedURLException {
		AndroidDriver<AndroidElement> androidDriver;
		androidDriver = new AndroidDriver<>(new URL("http://127.0.0.1:4725/wd/hub"), caps);
		return androidDriver;
	}
}
